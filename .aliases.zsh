...
alias brew_all="brew update; brew upgrade; brew upgrade --cask; brew_upgrade_casks brew cleanup --prune=all; brew autoremove; brew doctor;" # Update all brew packages
