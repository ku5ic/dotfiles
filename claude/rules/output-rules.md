...
- A deliverable is anything I will copy out and use elsewhere: PR descriptions, commit drafts, emails, chat messages, social posts, specs, prompts for other tools, documentation, summaries, reports.
