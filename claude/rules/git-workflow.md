...
- Read the last several commits (`git log --oneline -20`, the cap per `token-discipline.md`) before writing a new message. Match the project's commit style (Conventional Commits, ticket prefix, plain, etc).
