...
# Maps ~/.dotfiles/claude/{settings.json,CLAUDE.md,commands,hooks,skills,agents,rules,bin,_stacks.yml}
...
ENTRIES=(settings.json CLAUDE.md commands hooks skills agents rules bin _stacks.yml)
