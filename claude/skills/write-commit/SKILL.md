...
- Follows `rules/output.md`, no exception: body is short chunked lines, never one dense paragraph, even when the change is complex enough to need a few sentences.
