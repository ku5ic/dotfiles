---
name: wcag-audit
description: WCAG 2.2 AA audit checklist and severity rubric. Load when auditing accessibility of a component, page, or template regardless of stack (React, Next.js, Django templates, plain HTML).
---
