...
6. Close with the underlying design rationale or invariant tying the pieces together, if one exists, and name any known rough edge or open follow-up rather than implying the picture is fully closed.
