...
- Match the project's existing style before assuming Conventional Commits - see `rules/git-workflow.md`.
...
| Fixups for already-staged hunks          | `git absorb` (see `rules/cli-tools.md`) beats hand-written `rebase -i`   |
